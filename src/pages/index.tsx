            ...
            <div className="md:grid md:grid-cols-2 gap-6 lg:grid-cols-1">
              <div className="mt-4">
                <p className="text-sm text-pink-500 dark:text-pink-400">
                  &quot;Big fan of your themes. They&apos;re well-organized,
                  look clean, and are fast.&quot;
                </p>
              ...
              <div className="mt-4">
                <p className="text-sm text-orange-500 dark:text-orange-300">
                  &quotAmazing resource using @astrodotbuild and @tailwindcss! I
                  got it a week ago and have found the contents really useful.
                  5/5
                </p>
                <p className="text-xs mt-2 text-zinc-500">
